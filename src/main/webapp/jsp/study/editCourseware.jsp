...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<input type="hidden" id="id" name="id"    value="${courseware.id}">
			...
			<tr>
					<th>课件图片：</th>
					<td><input id="pic" name="pic" type="text" placeholder="" class="easyui-validatebox span2"  readOnly="readonly"  value="${courseware.pic}">
				...
				<tr>
					<th>附件名称：</th>
					<td><input id="url" name="url" type="text" placeholder="" class="easyui-validatebox span4"  readOnly="readonly""  value="${courseware.url}">
