...
$(document).ready(function() {
	$("#fileInput").uploadify({
		'uploader'       : '<%=request.getContextPath()%>/jquery.uploadify/uploadify.swf?var='+(new Date()).getTime(),
		'script'         : '/coursewareController/uploadFilePic.html',
		'cancelImg'      : '<%=request.getContextPath()%>/jquery.uploadify/cancel.png',
		'folder'         : 'uploadFile',
		'fileDataName': 'fileInput', 
		'queueID'        : 'fileQueue',
		'fileExt'        : '*.jpg;*.png;*.gif', //允许文件上传类型,和fileDesc一起使用.
		'fileDesc'       : '*.jpg;*.png;*.gif',  //将不允许文件类型,不在浏览对话框的出现.
		'auto'           : true,
		'multi'          : false,
		'sizeLimit'   : 100000000,
		'buttonText': 'Browse',
