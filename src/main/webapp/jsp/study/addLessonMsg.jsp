...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			...
			url : '${pageContext.request.contextPath}/courseController/saveLessonMsg.html',
			onSubmit : function() {
		...
		<form id="form" method="post">  
			...
			<select name="GRADE_ID" id="grade_id" style="width:160px;height: 40px;">
				...
				标题：
					...
					<td>					
			<input name="TITLE" type="text" placeholder="请输入标题" class="easyui-validatebox span3" data-options="required:true" value="">
					</td>
				</tr>
								<tr>
				<th>
				内容： 
					...
					<td>					
		<input name="CONTENT" type="text" placeholder="请输入内容" class="easyui-validatebox span3" data-options="required:true" value="">
					</td>
				</tr>
				<tr>
				<th>
