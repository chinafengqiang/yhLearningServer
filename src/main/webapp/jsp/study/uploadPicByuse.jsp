...
-->
   ...
   $(function() {
		...
		$("#btnImportFromFile").upload({
	        action: '${pageContext.request.contextPath}/coursewareController/uploadFilePic.html',
	        name: 'file',
	 ...
	 //       	alert(strs[1]);
		...
		function getReturnValue(name){
			if(window.ActiveXObject){ //IE
				...
				if(window.opener) {
					window.opener.setPicValue(name) ;
				}
				window.close();
			}
		}
		...
		<input id="btnImportFromFile" class="option_btn_g" type="button" value="选择文件">(支持30M文件)
		<div id="result"></div>
  </body>
</html>
