...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${pageContext.request.contextPath}/courseController/modifyCourseTable.html',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<input type="hidden" id="id" name="id"  value="${courseTable.id}">
			<table class="table table-hover table-condensed">
				<tr>
					<th>名称：</th>
					<td><input name="name" type="text" placeholder="请输入名称" class="easyui-validatebox span3" data-options="required:true"   value="${courseTable.name}"></td>
					<th></th>
					<td></td>
				</tr>
				<tr>
					<th>附件名称：</th>
					<td><input id="url" name="imageUrl" type="text" placeholder="" class="easyui-validatebox span4"  readOnly="readonly""  value="${courseTable.imageUrl}">
