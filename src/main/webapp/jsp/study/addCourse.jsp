...
<script type="text/javascript">
	$(function() {
		...
		parent.$.messager.progress('close');
		$('#form').form({
			url : '${pageContext.request.contextPath}/courseController/createCourse.html',
			onSubmit : function() {
	...
	<div data-options="region:'center',border:false" title="" style="overflow: hidden;">
		...
		<input type="hidden" id="coursewareCategoryId" name="coursewareCategoryId"  >
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th>附件名称：</th>
					<td><input id="url" name="url" type="text" placeholder="" data-options="required:true" class="easyui-validatebox span4"   value="">
					<img src="<%=request.getContextPath()%>/images/shangc.gif"  style="cursor:pointer;" onclick="uploadSave()">
					<th>课程图片：</th>
					<td><input id="pic" name="pic" type="text" placeholder="" class="easyui-validatebox span2"   value="">
				...
				<tr>
					<th>主讲人：</th>
					<td><input name="lectuer" type="text" placeholder="请输入主讲人" class="easyui-validatebox span3" data-options="" value=""></td>
					<th>课程简介：</th>
					<td><textarea name="description" id="description" placeholder="" class="easyui-validatebox span4"  rows="3" cols="20" class="text"></textarea>
					</td>
