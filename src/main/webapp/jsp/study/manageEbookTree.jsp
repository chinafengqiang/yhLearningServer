...
<jsp:include page="../../incApp.jsp"></jsp:include>
  ...
  $(function() {
    ...
    function returnFun(){
    	window.location = "${pageContext.request.contextPath}/coursewareController/createBookNodeList.html";
    }
...
<div id="">
			<table width="99%" border="0" cellspacing="0" cellpadding="0" id="index_content">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="index_main_div1">
					  <tr>
						<td height="21" background="<%=request.getContextPath()%>/image/index_main_div_titleBg.gif"><img style="margin-left:5px;" src="<%=request.getContextPath()%>/image/index_main_div_left.gif" width="6" height="2" align="absmiddle">&nbsp;<span style="font-weight:bold;font-size:12px;">电子书分类管理</span></td>
					  </tr>
					</table>
				</td>
				 </tr>
...
<table id="dataGrid"></table>
 <div id="dtreeContextMenu" onclick="event.cancelBubble = true;">
	  <ul>
    	<li><a href="javascript: dtreeContextMenu_add('<%=request.getContextPath()%>/coursewareController/addBook.html')">增加</a></li>
    	...
    	<li><a href="javascript: dtreeContextMenu_delete('<%=request.getContextPath()%>/coursewareController/removecoursewarecategory.html?method=1')">删除</a></li>
	  </ul>
	 </div>
</body>
</html>