...
$(function() {
	...
	var url = '${pageContext.request.contextPath}/coursewareController/sendBooks.html';
	var ids = '${ids}';
	if(ids != ""){
		url = "${pageContext.request.contextPath}/coursewareController/sendBooksBatch.html";
	}
	$('#form').form({
		url : url,
		onSubmit : function() {
