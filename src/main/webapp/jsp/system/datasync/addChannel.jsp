...
<script type="text/javascript">
	$(function() {
		submitForm('${pageContext.request.contextPath}/dataSyncController/saveChannel.html');
	});
</script>
		...
		<fieldset>
			<table class="table" style="width: 100%;">
				...
				<tr>
					<th>组播IP</th>
					<td>
						<input type="text" name="MIP" class="easyui-validatebox" data-options="required:true" />
					</td>
				</tr>
				<tr>
					<th>组播端口</th>
					<td>
						<input type="text" name="MPORT" class="easyui-validatebox" data-options="required:true" />
					</td>
				</tr>
				<tr>
					<th>带宽</th>
					<td>
					   <input type="text" id="BANDWIDTH" name="BANDWIDTH" class="easyui-validatebox" data-options="required:true"><strong>&nbsp;kbps</strong>
