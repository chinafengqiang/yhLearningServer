	...
	<div data-options="region:'north',title:'查询条件',border:false" style="height: 60px; overflow: hidden;">
		<form id="searchForm">
			<table class="table table-hover table-condensed" style="">
				<tr>
					<th>帐号：</th>
					<td><input name="name" id="name" placeholder="可以查询帐号" class="span2" /></td>
					<th>姓名：</th>
					<td><input name="actualName" id="actualName" placeholder="可以查询姓名" class="span2" /></td>
				</tr>
			</table>
		</form>
	</div>
...
<div id="toolbar" style="display: none;">
		...
		<a onclick="resetFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'pencil_add'">重置密码</a>
