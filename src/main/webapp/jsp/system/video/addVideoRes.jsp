...
<script type="text/javascript">
	$(function() {
		...
		$('#form')
				.form(
						{
							url : '${pageContext.request.contextPath}/videoController/createVideoRes.html',
							onSubmit : function() {
			...
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><input name="name" type="text" placeholder="请输入名称"
						...
						<input name="grade_id" value="${partId}" type="hidden">
						<input name="ispublic" value="${gradeId}" type="hidden">
						</td>
				...
				<tr>
					<th>主讲人：</th>
					<td><input name="lectuer" type="text" placeholder="请输入主讲人"
						class="easyui-validatebox span3" data-options=""
						value="">
						<input name="hour" value="0" type="hidden">
