 ...
 * 增加命名空间功能
 * 
 * 使用方法：fq('jQuery.bbb.ccc','jQuery.eee.fff');
 */
fq.ns = function() {
	var o = {}, d;
 ...
 * @author fq
 * 
 * @example fq.formatString('字符串{0}字符串{1}字符串','第一个变量','第二个变量');
 * 
 * @returns 格式化后的字符串
 */
fq.formatString = function(str) {
 ...
 * @returns list
 */
fq.stringToList = function(value) {
 ...
 * @author Klaus Hartl/klaus.hartl@stilbuero.de
 */
fq.cookie = function(key, value, options) {
